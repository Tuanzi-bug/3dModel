...
**Current focus:** Phase 1 - MVP Hardening & Consistency
...
- [Init] Template-specific editor coupling currently obscures the core save/reopen model and should be simplified during Phase 1
